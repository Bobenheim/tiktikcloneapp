...
const Search = ({ videos }: { videos: Video[] }) => {
  ...
  return (
    <div className='w-full'>
        <div className='flex gap-10 mb-10 mt-10 border-b-2 border-gray-200 bg-white w-[80vw]'>
            ...
            <div className='md:mt-16'>
                {searchedAccounts.length > 0 ? (
                    ...
                    <Link href={`/profile/${user._id}`} key={idx}>
                      <div className='flex items-center gap-3 p-2 cursor-pointer font-semibold rounded border-b-2 border-gray-200'>
